...
const BarPokemon = ({ name, lvl, className }: Props) => {
  return (
    <div
      className={cx(
        "bg-[#fafcdc] w-[180px] pl-3 pt-1 pb-1 pr-2 font-nova inline-flex flex-col font-bold border-[#262e0c] border-[3px] rounded-[8px] rounded-tl-[14px] rounded-br-[14px]",
        className
      )}
    >
